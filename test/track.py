...
class TrackApplication(AbstractApplication, TextToSpeechComponent, DisplayComponent, FaceRecognitionComponent, ObjectDetectionComponent, SpeechRecognitionComponent, CameraComponent, MicrophoneComponent):
